...
implementation, as the internal binary representation of the integer is the same whether it
...
class Solution:
    def reverseBits(self, n):
        ...
        res = 0
        for i in range(32):
            # Shifts res in 1 bit to the left
            res <<= 1
            # Check if the rightmost bit in n is equal to 1
            if n & 1 == 1:
                res += 1
            # Shifts n in 1 bit to the right
            n >>= 1
        return res