...
def div_count(a, b, k):
    last_div_num = b//k*k
    first_div_num = ((a+k-1)//k)*k
    print(last_div_num, first_div_num)
    return int((last_div_num-first_div_num)/k+1)


def div_count2(a, b, k):
    last_div_num = math.floor(b/k)*k
    first_div_num = math.ceil(a/k)*k
    print(last_div_num, first_div_num)
    return int((last_div_num-first_div_num)/k+1)


print(div_count2(6, 11, 2))
