...
class Solution:
    ...
    def minTimeToVisitAllPoints(self, points):
        ...
        for i in range(1, len(points)):
            ...
            cost += max(abs(start_point[0]-next_point[0]), abs(start_point[1]-next_point[1]))

        return cost



    # a bad code, not good at all cases, failed in leetcode
    ...
    def find_diagonal_line_point2(self, point_start, point_destination):
    ...
    def find_diagonal_line_point(self, point_start, point_destination):
        ...
        distance_from_diag_x = abs(point_destination[0] - point_start[0])
        distance_from_diag_y = abs(point_destination[1] - point_start[1])

        # if distance_x > distance_y:
        #     return [point_destination[1], diagonal_y]
        # else:
        #     return [diagonal_x, point_destination[1]]
