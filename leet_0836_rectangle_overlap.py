...
class Solution:
    def isRectangleOverlap(self, rec1: List[int], rec2: List[int]) -> bool:
        # view the first as a triangle, check if the other comes to top, left, bottom or right
        if rec1[1] >= rec2[3] or rec2[1] >= rec1[3] or rec1[2] <= rec2[0] or rec2[2] <= rec1[0]:
            return False
        return True

    # a second solution by checking size of rectangles
    def isRectangleOverlap(self, rec1: List[int], rec2: List[int]) -> bool:
