...
Input: n = 5
Output: 12
Explanation: For example [1,2,5,4,3] is a valid permutation, but [5,2,3,4,1] is not because the prime
...
class Solution:
    def numPrimeArrangements(self, n: int) -> int:
        ...
        return math.factorial(primeCount) * math.factorial(n - primeCount) % (10 ** 9 + 7)