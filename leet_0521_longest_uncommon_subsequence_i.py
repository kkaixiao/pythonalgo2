...
From problem description, the longest uncommon subsequence is defined as the longest subsequence 
of one of these strings and this subsequence should not be any subsequence of the other strings.

And, any string is a subsequence of itself and an empty string is a subsequence of any string.

Therefore, the longest uncommon subsequence is the longest length of both strings if strings are 
not equal.

However, if the both strings are equal, return -1.
"""
